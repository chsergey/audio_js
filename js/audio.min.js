(function (h , o , g) {
	...
	g[h] = {instanceCount : 0 , instances : {} , flashSource : '      <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="$1" width="1" height="1" name="$1" style="position: absolute; left: -1px;">         <param name="movie" value="$2?playerInstance=' + h + '.instances[\'$1\']&datetime=$3">         <param name="allowscriptaccess" value="always">         <embed name="$1" src="$2?playerInstance=' +
		...
		} , init : function () {g[h].helpers.addClass(this.wrapper , this.settings.createPlayer.loadingClass)} , loadStarted : function () {
	...
	} , helpers : {merge : function (b , a) {for (attr in a)if ( b.hasOwnProperty(attr) || a.hasOwnProperty(attr) )b[attr] = a[attr]} , clone : function (b) {
		if ( b ==
		...
		if ( b.addEventListener )b.addEventListener(a , c , false); else if ( b.attachEvent ) {
			...
			if ( !this.memoryLeaking ) {
				window.attachEvent("onunload" , function () {if ( this.listeners )for (var d = 0, e = this.listeners.length; d < e; d++)g[h].events.purge(this.listeners[d])});
	...
	g[o].prototype = {updatePlayhead : function () {this.settings.updatePlayhead.apply(this , [this.element.currentTime / this.duration])} , skipTo : function (b) {
		...
		loadError : function () {this.settings.loadError.apply(this)} , init : function () {this.settings.init.apply(this)} , loadStarted : function () {
		...
		} , playPause : function () {this.playing ? this.pause() : this.play()} , play : function () {
		...
		setVolume : function (b) {this.element.volume = b} , trackEnded : function () {
...
audiojs.events.ready(function() {
	window.ajs = audiojs.createAll();
	if(ajs && ajs.length) {
		$('p.play').click(function(){
			var src = $(this).parent().parent().find('audio').attr('src');
			for(var j = 0; j <= ajs.length-1; j++){
				if (ajs[j].playing && ajs[j].mp3 != src){
					ajs[j].pause();
				}
			}
		});
